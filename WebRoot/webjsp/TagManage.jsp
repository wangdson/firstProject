			...
			<div class="row-fluid">		
				...
				<div class="box-header well" data-original-title>
					...
					<div align="right" style="float: right;">
					   <a class="btn btn-small btn-primary btn-add">添加标签</a>
					</div>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">
									<a class="btn btn-danger" href="WallPaperConfigAction!getTagWallpaperList?tagId=${item.tagId}">
										<i class="icon-edit icon-white"></i>
										壁纸包配置
									</a>
									<a class="btn btn-danger" href="TagMangerAction!deleteTag?tagId=${item.tagId}">
