	...
	<p style="font-size: 10px;font-weight: bold;">
			<div class="row-fluid">		
				...
				<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i>分类列表</h2>
						<div class="box-icon">
					...
					<div align="right" style="float: right;">
					   <a class="btn btn-small btn-primary btn-add">添加分类</a>
					</div>
					...
					<br/><br/>
						<table class="table table-striped table-bordered bootstrap-datatable datatable" >
						  ...
						  <c:forEach var="msg" items="${categoryList}">
							<tr>
								<td>${msg.categoryId}</td>
								<td>${msg.categoryName}</td>
								<td class="center">
									<a class="btn btn-info" href="TagConfigAction?classificationId=${msg.categoryId}">
										<i class="icon-edit icon-white"></i>
										标签配置                   
									</a>
									<a class="btn btn-danger" href="WallPaperConfigAction?classificationId=${msg.categoryId}">
										<i class="icon-edit icon-white"></i>
										壁纸包配置
									</a>
								</td>
						...
						<div class="modal-body">
							<div class="row-fluid sortable">
								<div class="box span12">
									<div class="box-content">
										<br />
								<form id="push_form" action="ClassificationAction!addClassification">
									<table>
										<tr>
											<td>分类名称:</td>
											<td><textarea name="classificationName"></textarea></td>
										</tr>
										<tr><td><br/></td></tr>
										<tr>
											<td><input id="mod"
