			...
			<div class="row-fluid">		
				...
				<div class="box-header well" data-original-title>
					...
					<div align="right" style="float: right;">
						<a href="WallpaperToClassificationAction?mode=${mode}" class="btn btn-small btn-primary"><i class="icon-chevron-left icon-white"></i> 配置</a> 		
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">
									<a class="btn btn-info" href="WallPaperConfigAction!deleteConfigCategoryPaper?wallPaperId=${item.id}">
