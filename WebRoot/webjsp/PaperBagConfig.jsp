			...
			<div class="row-fluid">		
				...
				<div class="box-header well" data-original-title>
					...
					<div align="right" style="float: right;">
						<a class="btn btn-small btn-primary" onclick="transferForm('WallpaperToClassificationAction!classificationConfigOfWallPaper');"><i class="icon-chevron-left icon-white"></i>配置</a>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <thead>
							  <tr>
								  ...
								  <th width="160px">壁纸名</th>
								  <th>操作</th>	
							  </tr>
						  </thead>   
						  <tbody>
							<c:forEach var="item" items="${paperBagList}">
							<tr>
								...
								<td class="center">
								    ...
								    <c:if test="${mode eq 'tag'}">
										<a class="btn btn-info" href="WallpaperToClassificationAction!wallPaperConfig?wallPaperId=${item.id}">
											<i class="icon-edit icon-white"></i>  
											分配                     
										</a>
                                	</c:if>
                                	
                                	 <c:if test="${item.state eq 'category'}">
										<a class="btn btn-info" href="TagConfigAction?tagId=${item.id}">
											<i class="icon-edit icon-white"></i>  
											分配                     
										</a>
                                	</c:if>
